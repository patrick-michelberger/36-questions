...
const englishUsOutput = {
  ...
  COMMON: {
    WELCOME_FIRST_TIME: 'Welcome to Wingman! Research lists 36 questions you can ask someone if you want to fall in love. Or make your love even stronger. This skill provides the ideal experience for exploring these questions, so grab some wine, sit down with someone you want to love and lets get started.',
